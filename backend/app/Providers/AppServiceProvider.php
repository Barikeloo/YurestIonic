...
use App\Product\Infrastructure\Notification\BroadcastProductPhotoUploadNotifier;
use App\Product\Domain\Interfaces\ProductRepositoryInterface;
use App\Product\Infrastructure\Persistence\Repositories\EloquentProductPhotoUploadTokenRepository;
use App\Product\Infrastructure\Persistence\Repositories\EloquentProductRepository;
use App\Product\Infrastructure\Storage\FilesystemProductPhotoStorage;
...
use App\Sale\Infrastructure\Persistence\Repositories\EloquentChargeSessionLineAssignmentRepository;
...
class AppServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(ProductPhotoUploadTokenRepositoryInterface::class, EloquentProductPhotoUploadTokenRepository::class);
        $this->app->bind(ProductPhotoStorageInterface::class, FilesystemProductPhotoStorage::class);
        $this->app->bind(ProductPhotoUploadNotifierInterface::class, BroadcastProductPhotoUploadNotifier::class);
        ...
        $this->app->bind(ChargeSessionLineAssignmentRepositoryInterface::class, EloquentChargeSessionLineAssignmentRepository::class);
