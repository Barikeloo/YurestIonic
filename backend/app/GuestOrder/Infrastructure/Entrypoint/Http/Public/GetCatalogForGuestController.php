...
use App\GuestOrder\Application\GetCatalogForGuest\GetCatalogForGuest;
use App\GuestOrder\Application\GetCatalogForGuest\GetCatalogForGuestCommand;
use App\GuestOrder\Domain\Exception\TableQrTokenNotFoundException;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

final class GetCatalogForGuestController
{
    public function __construct(
        private readonly GetCatalogForGuest $getCatalogForGuest,
    ) {}

    public function __invoke(Request $request, string $token): JsonResponse
    {
        try {
            $response = ($this->getCatalogForGuest)(new GetCatalogForGuestCommand(token: $token));
